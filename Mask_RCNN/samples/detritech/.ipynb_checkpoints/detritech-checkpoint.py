...
class DetritechConfig(Config):
    ...
    NUM_CLASSES = 1 + 3  # Background + beton + acier + bois
...
class DetritechDataset(utils.Dataset):

    def load_detritech(self, dataset_dir, subset):
        """Load a subset of the Balloon dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # Add classes. 
        self.add_class("detritech", 1, "beton")
        self.add_class("detritech", 2, "acier")
        self.add_class("detritech", 3, "bois")
        ...
        for a in annotations:
            ...
            if type(a['regions']) is dict:
                ...
                types = [r['region_attributes']['type'] for r in a['regions']]
...
#             print(polygons)
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "detritech":
...
def train(model):
    """Train the model."""
    # Training dataset.
    dataset_train = DetritechDataset()
    dataset_train.load_detritech(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = DetritechDataset()
    dataset_val.load_detritech(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect detritus.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/detritech/dataset/",
                        help='Directory of the Detritech dataset')
